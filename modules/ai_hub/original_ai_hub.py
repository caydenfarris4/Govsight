...
from regulatory_auto_integrator import (
    query_with_sources,                     # Static source queries
    ...
    format_external_results,                # Format external results
    get_available_external_sources,         # Get available external sources
    get_available_states                    # Get available states for state regulations
)
...
def generate_pdf_report(df: pd.DataFrame, title: str = "AI Analysis Report", analysis_text: Optional[str] = None, 
    ...
    """
    Generate a PDF report with data analysis and insights

...
# --- User Roles ---
USERS = {
    "admin_user": {"role": "admin", "departments": "all"},
    "finance_director": {"role": "finance", "departments": "all"},
    "pw_manager": {"role": "manager", "departments": ["Public Works"]},
    "police_manager": {"role": "manager", "departments": ["Police"]},
    "parks_manager": {"role": "manager", "departments": ["Parks & Rec"]},
}
